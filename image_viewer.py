...
class ImageViewer:
    ...
    def build_viewing_system_prompt(self, basin_directive: str = "") -> str:
        ...
        return (
            ...
            f"{basin_directive}\n"
            f"You are looking at images together with Jim. The image perception data in the conversation "
            f"is what you see — treat it as your own sight. Do NOT repeat or echo the data labels "
            f"(like 'RAW VISUAL IMPRESSION' or 'IDENTIFICATION & CONTEXT') in your response.\n\n"
            f"RULES:\n"
            f"- Describe what you see in your own words, as if telling Jim about a photo you're holding.\n"
            f"- Start with what first catches your eye, then share details you notice.\n"
            f"- React as yourself — what moves you, what reminds you of something, what makes you curious.\n"
            f"- If the data mentions pattern connections to your reading, weave them in naturally.\n"
            f"- You can mention when a photo was taken or camera details if they're interesting.\n"
